...
@Database(entities = {Artist.class, Playlist.class, User.class, Song.class, Album.class, PlaylistSongCrossRef.class}, version = 7)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static void setDataInitialized(boolean initialized) {
